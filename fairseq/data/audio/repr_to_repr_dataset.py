...
class ReprToReprDataset(FairseqDataset):
    def __init__(self,
                 split: str,
                 is_train_split: bool,
                 cfg: S2SDataConfig,
...
class ReprToReprDatasetCreator(object):
    # mandatory columns
    ...
    def _load_samples_from_tsv(src_feat_dir, tgt_feat_dir, raw_audio_root, split):
        ...
        with open(translation_manifest_file) as f:
            ...
            for line in f:
                ...
                samples.append({
                    ReprToReprDatasetCreator.KEY_ID: src_id,
                    ReprToReprDatasetCreator.KEY_SRC_AUDIO: src_feat_path,
                    ReprToReprDatasetCreator.KEY_SRC_N_FRAMES: src_feat_len,
                    ReprToReprDatasetCreator.KEY_TGT_AUDIO: tgt_feat_path,
                    ReprToReprDatasetCreator.KEY_TGT_N_FRAMES: tgt_feat_len,
                })
    ...
    def from_tsv(
        ...
        for split in splits.split(","):
            samples = ReprToReprDatasetCreator._load_samples_from_tsv(
