...
@register_task("cmlm_cg", dataclass=TranslationLevenshteinConfig)
class CMLMClassifierFreeGuidanceTask(TranslationTask):
    """
    ...
    def build_generator(self, models, args, **unused):
        ...
        # print("Building generator for cg, with cg scale: {}".format(args.cg_scale))
        # exit(0)
