...
@register_task("repr_to_speech")
class ReprToSpeechTask(LegacyFairseqTask):
    @classmethod
    ...
    def __init__(self, args, tgt_dict):
        ...
        if "chenyuz" in args.dummy_config:
            args.dummy_config = "/weka/scratch/jzhan237/diff_s2s/CVSS/es-en/en2es/reduce_unit/config.yaml"
    ...
    def build_generator(
        ...
        if self.args.target_is_code:
            assert self.args.n_frames_per_step == 1
