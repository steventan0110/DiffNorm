...
NOISE_CHOICES = ChoiceEnum(["random_delete", "random_mask", "no_noise", "full_mask", "ran", "random_mask_gaus"])
...
class TranslationLevenshteinConfig(TranslationConfig):
    ...
    decode_with_true_length: bool = field(
        default=False,
        metadata={"help": "decode with true length"},
    )
...
class TranslationLevenshteinTask(TranslationTask):
    ...
    def create_gaussian_mask(target_lens, target_masks):
        ...
        max_len = target_lens.max().item() + 2 # +1 to handle eos and bos
        # TODO: generalize these hyper-params?
        shift_low, shift_high = 0, target_lens // 8
    ...
    def inject_noise(self, target_tokens):
        ...
        if self.cfg.noise == "random_delete":
            ...
            return _random_mask(target_tokens)
        elif self.cfg.noise == "random_mask_gaus":
            return _random_mask_gaus(target_tokens)
    ...
    def build_generator(self, models, args, **unused):
        ...
        return IterativeRefinementGenerator(
            ...
            use_true_length=self.cfg.decode_with_true_length,
        )
