...
from fairseq.data.audio.audio_to_repr_unit_dataset import AudioToReprUnitDatasetCreator
...
@register_task("sedd_lm")
class ScoreEntropyDiffusionLMTask(LegacyFairseqTask):
    @classmethod
    def add_args(cls, parser):
        ...
        parser.add_argument(
            "--nat_ckpt",
            type=str,
            help="path to the pre-trained nat ckpt"
        )
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        self.datasets[split] = AudioToReprUnitDatasetCreator.from_tsv(
