...
from fairseq.data.audio.repr_to_repr_dataset import ReprToReprDatasetCreator
...
@register_task("speech_diffusion_hubert")
class SpeechDiffusionHubertTask(LegacyFairseqTask):
    @classmethod
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        self.datasets[split] = ReprToReprDatasetCreator.from_tsv(
